...
<section class="h1Header" style=background-image:url("../images/topH1Bg.jpg";>
...
<h1>Portfolio</h1>
    ...
    <li><a href="index.html">Home</a> </li>
    <li><a href="portfolio3col.html">Portfolio</a></li>
    </ul>
...
<!-- Pagination  starts
  ====================
<ul class="pagination portfolioSinglePagination ">
...
$basedir = '/home/xavier-marketing.com/';
$baseurl = 'http://xavier-marketing.com/';
@files = ('*.html');
$title = "Search Results";
$title_url = 'http://xavier-marketing.com/';
$search_url = 'http://xavier-marketing.com/';
